...
class PrintBatch(SQLModel, table=True):
    """
    A group of `registered` orders atelier staff batch together to print on
    ...
    # Human-readable code the atelier staff sees on screen / on the sheets, e.g. BATCH-0001.
